...
export default function PicSelect({ setPic, showPicker }: {setPic:  React.Dispatch<React.SetStateAction<string>>, showPicker: React.Dispatch<React.SetStateAction<boolean>>}) {
    const pics = ["https://sun9-76.userapi.com/impg/jhJ5bKuIELN9NPIQIAvSxWUqQEyht9GFuXaUNA/ufsy0JoAQUk.jpg?size=400x400&quality=96&sign=45c3f28bc82aa689d2fbb493ab0e9d6c&type=album",
